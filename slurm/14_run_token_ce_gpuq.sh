...
# =============================================================================
# Runner (Token-level CE; gpuq; GPU): executes the Nth line of a jobfile
# =============================================================================
...
if [[ -z "$JOBFILE" ]]; then
  ...
  echo "Usage: sbatch --array=0-N slurm/14_run_token_ce_gpuq.sh <jobfile>" >&2
  exit 1
fi
if [[ ! -f "$JOBFILE" ]]; then
