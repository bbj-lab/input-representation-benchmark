...
echo "  2. Exp1 Stage 0 (tier2q CPU): sbatch --array=0-11%2 slurm/02_run_stage0_tier2q_tokenize.sh slurm/generated/demo/04_exp1_stage0_tokenize.jobfile"
echo "  3. Exp1 Stage 1 (8 GPUs/job): TRAIN_JID=\$(sbatch --parsable --array=0-11%2 slurm/05_run_stage1_gpu8_train.sh slurm/generated/demo/07a_exp1_stage1_train.jobfile)"
echo "  4. Exp1 Stage 2 (2 GPUs/job): EXTRACT_JID=\$(sbatch --parsable --dependency=afterok:\"\${TRAIN_JID}\" --array=0-11%4 slurm/09_run_stage2_gpu2_extract.sh slurm/generated/demo/07b_exp1_stage2_extract_reps.jobfile)"
echo "  5. Exp1 Stage 3 (tier2q LR): sbatch --dependency=afterok:\"\${EXTRACT_JID}\" --array=0-11%8 slurm/11_run_stage3_tier2q_lr.sh slurm/generated/demo/07c_exp1_stage3_lr.jobfile"
