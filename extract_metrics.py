...
def extract_metrics(pattern, metrics):
    ...
    for f in sorted(files):
        ...
        try:
            ...
            results[f"Error reading {f}"] = str(e)
...
if __name__ == "__main__":
    ...
    print("-" * 50)
    res_reg = extract_metrics("data/**/test/reg_ridge_regression-preds*.pkl", [])
    ...
    print("-" * 50)
    res_mlp = extract_metrics("data/**/test/mlp-preds*.pkl", [])
    ...
    print("-" * 50)
    res_lr = extract_metrics("data/**/test/logistic_regression-preds*.pkl", [])
