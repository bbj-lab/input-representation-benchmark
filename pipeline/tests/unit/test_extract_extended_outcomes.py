...
from pipeline.scripts.extract_extended_outcomes import _compute_extended_outcomes
    ...
    def test_post24h_targets_and_first24h_exclusions(self) -> None:
        ...
        meds = pl.DataFrame(
            [
                ...
                {"subject_id": 1, "hadm_id": 100, "time": t0 + timedelta(hours=31), "code": "VITAL//220045//bpm", "numeric_value": 102115.0},
                {"subject_id": 1, "hadm_id": 100, "time": t0 + timedelta(hours=31), "code": "VITAL//220179//mmHg", "numeric_value": 101110.0},
                {"subject_id": 1, "hadm_id": 100, "time": t0 + timedelta(hours=31), "code": "VITAL//220180//mmHg", "numeric_value": 98109.0},
        ...
        self.assertAlmostEqual(float(row100["max_heart_rate"]), 100.0, places=6)
