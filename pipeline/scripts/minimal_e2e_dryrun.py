...
def main(argv: list[str] | None = None) -> int:
    ...
    irb_home = Path(__file__).resolve().parents[2]
    p.add_argument(
        "--irb_home",
        type=Path,
        default=irb_home,
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        from pipeline.scripts.extract_outcomes_meds import main as extract_outcomes_main
        ...
        # Normalize layout
        from pipeline.scripts.normalize_meds_tokenized_layout import main as norm_main
