#!/usr/bin/env python
# =============================================================================
# Pre-MEDS Data Wrangling for MIMIC-IV
# =============================================================================
#
# This file is adapted from the ETHOS-ARES repository:
#   https://github.com/ipolharvard/ethos-ares
#
# Original authors: Pawel Renc, Michal K. Grzeszczyk, Nassim Oufattole,
#                   Deirdre Goode, Yugang Jia, Szymon Bieganski,
#                   Matthew B.A. McDermott, Jaroslaw Was, Anthony E. Samir,
#                   Jonathan W. Cunningham, David W. Bates, Arkadiusz Sitek
#
# License: MIT License (Copyright (c) 2024 Paweł Renc)
#
# Citation:
#   Renc, P., et al. (2025). Foundation Model of Electronic Medical Records
#   for Adaptive Risk Estimation. GigaScience, 14, giaf107.
#   https://doi.org/10.1093/gigascience/giaf107
#
# =============================================================================
